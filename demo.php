...
<div id="wrapper">
  <div class="iconcontainer">
    <ul>
      <li>
        <div id="product_video" onmouseover="change_product_video('1');"><a href="product.php"><img src="images/icelero.png" alt="Product" title="Product" width="125" height="125" /></a></div>
     ...
     <li>
        ...
        <div class="subcategory"  id="view_postQuery" style=" display:none;" onclick="change_postQuery('0');" >
